/**
 * ============================================================
 * SOLUTIONHUB CORE v9.1 – FIXED RAZORPAY + OLD FRONTEND COMPAT ✅
 * ============================================================
 */
...
// Socket.IO CORS = old behaviour (any origin)
...
/* ============================================================
   🔍 ENV DEBUG (helps if something breaks)
============================================================ */
...
/* ============================================================
   🆕 RAZORPAY SETUP (fixed, but does NOT change API shape)
============================================================ */
let razorpay = null;
...
try {
  ...
  // Optional tiny test (won't affect frontend)
  (async () => {
    try {
...
/* ============================================================
   MIDDLEWARE
   (matches your OLD behaviour so frontend keeps working)
============================================================ */
app.use(cors()); // allow all origins – same as your original server
app.use(express.json({ limit: "10mb" }));
app.use(express.urlencoded({ extended: true }));
app.use(express.static(path.join(__dirname, "public")));   // serve /public exactly as before
...
/* ============================================================
   ...
   (paths remain EXACTLY as before)
============================================================ */
...
/* ============================================================
   ROUTES - ENHANCED EXPERT SIGNUP (same endpoints)
============================================================ */
...
app.post("/api/pro-signup", upload.fields([
  ...
  try {
    const { 
      name, email, password, field, experience, 
      headline, summary, linkedin, price 
    } = req.body;
...
/* ============================================================
   ...
   (endpoints unchanged so frontend works)
============================================================ */
